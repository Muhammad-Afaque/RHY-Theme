...
<section id="hero_section">
    <video id="videobcg_hero" preload="auto" autoplay="" loop="" muted="" playsinline="" crossorigin="anonymous">
<!--     <source src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/Hydrasearch Recreational.mp4" type="video/mp4"> -->
<!--     <source src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/Hydrasearch Recreational.webm" type="video/webm"> -->
    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-md-9">
                ...
                <p>Innovative solutions for ice management, weed control, and <br> stunning water features for your
                    waterways
                </p>
                <a class="CTAHomePage" href="#">
                    Read More
                </a>
            </div>
        </div>
        <div class="container">
            <div class="social_media_icons">
                <ul>
                    <li><a href="#"><img
                                src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/insta.svg"
                                alt=""></a></li>
                    <li><a href="#"><img
                                src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/facebook.svg"
                                alt=""></a></li>
                    <li><a href="#"><img
                                src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/twitterX.svg"
                                alt=""></a></li>
